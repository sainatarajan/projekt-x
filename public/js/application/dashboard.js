...
function init() {
    setInterval(loadStateFromDatabase, 2000)
}
...
function loadGUIState(data) {
    for(var i= 0; i<data.length; i++) {
        ...
        $(".main-div").remove()
        $(".device-row").append("<div class=\"col-md-12 main-div\"><div class=\"tile appliance-tile\"><div class=\"tile-title-w-btn\"><b>Device Name: "+deviceName+"</b><b>Device ID: "+deviceID+"</b><br><br><p><button class=\"btn btn-primary icon-btn btn-appliance-add\"><i class=\"fa fa-toggle-on\"></i>Switch On All</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class=\"btn btn-secondary icon-btn btn-appliance-remove\"><i class=\"fa fa-toggle-off\"></i>Switch Off All</button></p></div><div class=\"row "+deviceID+"\"></div></div></div>")
